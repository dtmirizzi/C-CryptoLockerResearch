...
void rsa_gen_keys(struct key_class *pub, struct key_class *priv, const char *PRIME_SOURCE_FILE);
...
long long *rsa_encrypt(const char *message, const unsigned long message_size, const struct key_class *pub);
...
char *rsa_decrypt(const long long *message, const unsigned long message_size, const struct key_class *pub);
